# Special Characters
A list of all valid special characters is presented here. This list can also be accessed from Python via the `SPECIALCHARS` or `SPECIALCHARS_DESCRIPTIONS` module constants.
